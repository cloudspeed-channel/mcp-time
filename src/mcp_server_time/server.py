...
def get_local_tz(local_tz_override: str | None = None) -> ZoneInfo:
    ...
    env_tz = os.environ.get("LOCAL_TIMEZONE")
    if env_tz:
...
async def serve(local_timezone: str | None = None) -> None:
    ...
    print(f"✅ MCP Time Server started. Local timezone = {local_tz}", flush=True)
    print("ℹ️ Waiting for MCP client connection over stdio...", flush=True)
